...
CACHE_TTL_SECONDS = int(os.getenv("MEDINSIGHT_CACHE_TTL_SECONDS", str(3 * 60 * 60)))
CACHE_SIMILARITY_THRESHOLD = float(
    os.getenv("MEDINSIGHT_CACHE_SIMILARITY_THRESHOLD", "0.78")
)
RELATED_QUERY_SIMILARITY_THRESHOLD = float(
    os.getenv("MEDINSIGHT_RELATED_QUERY_SIMILARITY_THRESHOLD", "0.62")
)
RELATED_QUERY_FOLLOW_UP_THRESHOLD = float(
    os.getenv("MEDINSIGHT_RELATED_QUERY_FOLLOW_UP_THRESHOLD", "0.45")
)
RELATED_QUERY_LOOKBACK = int(os.getenv("MEDINSIGHT_RELATED_QUERY_LOOKBACK", "6"))
